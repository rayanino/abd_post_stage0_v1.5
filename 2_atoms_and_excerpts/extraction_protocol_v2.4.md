...
gold_standard_schema_v0.3.1.json      (copy from baseline)
...
### Compute manifest:
SHA-256 for every file. Compute baseline_sha256 fingerprint. Update baseline_id to `{passage}_v0.3.1`.
...
*Protocol version: 2.1 — Aligned with gold standard schema v0.3.1 and project glossary v1.1.1. Replaces extraction_protocol v0.2.2.*